  ...
  const features = [
    {
      ...
      description:
        "প্রযুক্তি এবং কৃষিকে একত্রিত করে কৃষিতে নতুন একটি মাত্রা যোগ করা হচ্ছে।",
    },
    {
      icon: "🥕",
      title: "যন্ত্রপাতি শেয়ারিং",
      description:
        "যন্ত্রপাতি কিনতে বা ভাড়া নিতে পারেন, যা খরচ কমাতে সাহায্য করে।",
    },
    {
      icon: "💡",
      title: "বিশেষজ্ঞ পরামর্শ",
      description:
        "কৃষি বিশেষজ্ঞদের কাছ থেকে পরামর্শ নেওয়া যায়। এই পরামর্শগুলি ভাল ফলাফল অর্জনে সহায়ক হতে পারে।",
    },
  ];
          ...
          <div className="row A-circles-row">
            ...
            <div className="col-lg-6 circles-right mt-lg-0 mt-5 align-self position-relative">
              ...
              <h3 className="title-A mb-4">
                বিশেষজ্ঞ পরামর্শ প্রদান, <br />
                যন্ত্রপাতি ভাড়া এবং স্টোরেজ পরিষেবা
              </h3>
              <p style={{ textAlign: "justify" }}>
                কৃষকদের উপযুক্ত পরামর্শ প্রদান করুন যেমন ফসল নির্বাচন, মাটি
                ব্যবস্থাপনা, এবং আধুনিক কৃষি কৌশল। একটি সাশ্রয়ী এবং শেয়ার্ড
                অর্থনীতির মডেল মাধ্যমে কৃষকদের প্রয়োজনীয় কৃষি যন্ত্রপাতি এবং
                মেশিনারি সহজে ব্যবহারযোগ্য করে তুলুন। কৃষকদের সরাসরি স্টোরেজ
                সুবিধার সাথে যুক্ত করুন যাতে তারা তাদের ফলন সংরক্ষণ করতে পারে
                এবং পরবর্তী ফলন হারানোর পরিমাণ কমাতে পারে।
              </p>
            ...
            <div className="content-info-in row align-items-center">
              <div className="content-left col-lg-6 pe-lg-5">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="row content4-right-grids mb-sm-5 mb-4 pb-3"
                  >
            ...
            <div className="row middle-section align-self">
              <div className="col-lg-6 video-info pe-lg-5">
                <div className="title-content text-left">
                  ...
                  <h3 className="title-A-light two pe-lg-5">
                    দৃঢ় অর্থনীতি গড়তে কৃষি উন্নয়ন করুন
                  </h3>
                  <a
                    href="/contact"
                    className="btn btn-style btn-outline-light mt-sm-5 mt-4"
                  >
                    এখনই যোগাযোগ করুন
                  </a>
                </div>
